//create a function that will find a specific data (year) on the object using find() method.
//this function will check to see if Denver team ever won the superbowl
const record = [
...
// * The function should receive 1 argument, an `Array` of JavaScript `Object`s (array = record)
    function superBowl(element, array){
...
let results = record.find(superBowl)
console.log(results)
